...
<template>
  <section class="login-page">
    <div
      class="login-page__curve login-page__curve--top"
      aria-hidden="true"
    />
    <div
      class="login-page__curve login-page__curve--bottom"
      aria-hidden="true"
    />
    <div
      class="login-page__square login-page__square--one"
      aria-hidden="true"
    />
    <div
      class="login-page__square login-page__square--two"
      aria-hidden="true"
    />
    ...
    <div class="container mx-auto px-6 py-16 md:py-24 relative z-10">
      ...
      <div class="login-options">
        ...
        >
          <span
            class="login-tile__index"
            aria-hidden="true"
          >01</span>
          <span
            class="login-tile__icon login-tile__icon--pmi"
            aria-hidden="true"
          >
            PMI
          </span>
        ...
        >
          ...
          >02</span>
          <span
            class="login-tile__icon login-tile__icon--google"
            aria-hidden="true"
          >
            <svg
              viewBox="0 0 48 48"
...
.login-tile:focus-visible {
  ...
  box-shadow: 0 24px 60px rgba(236, 104, 60, 0.14);
  outline: none;
  transform: translateY(-4px);
}

.login-tile:hover::before,
.login-tile:focus-visible::before {
...
.login-tile__copy strong {
  color: var(--color-ink);
  font-size: 1.1rem;
  font-weight: 700;
}

.login-tile__copy span {
  color: var(--color-ink-muted);
  font-size: 0.82rem;
  line-height: 1.5;
}
...
.login-tile:hover .login-tile__arrow,
.login-tile:focus-visible .login-tile__arrow {
...
.login-page__curve--top {
  width: 32rem;
  height: 32rem;
  top: -24rem;
  right: -8rem;
  box-shadow: 0 0 0 36px var(--industrial-accent-wash);
}

.login-page__curve--bottom {
  width: 24rem;
  height: 24rem;
  bottom: -18rem;
  left: -8rem;
  box-shadow: 0 0 0 28px var(--industrial-grid);
}
